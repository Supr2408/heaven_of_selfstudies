          ...
          <div className="grid w-full overflow-hidden rounded-[2rem] border border-slate-200 bg-white/90 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.45)] backdrop-blur md:grid-cols-[1.15fr_0.85fr]">
            <div className="order-2 border-t border-slate-200 bg-slate-950 px-6 py-7 text-white md:order-1 md:border-t-0 md:border-b-0 md:border-r md:px-10 md:py-12">
              ...
              <div className="mt-8 space-y-4 md:mt-10 md:space-y-5">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-blue-300 sm:text-sm sm:tracking-[0.25em]">
                  Community Access
                </p>
                <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">
                  Join the NPTEL Hub learning community.
                </h1>
                <p className="max-w-xl text-sm leading-6 text-slate-300 sm:leading-7">
            ...
            <div className="order-1 px-6 py-7 md:order-2 md:px-10 md:py-12">
              <div className="mx-auto flex h-full max-w-md flex-col justify-center">
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-blue-600 sm:text-sm sm:tracking-[0.2em]">
                  Welcome Back
                </p>
                ...
                <div className="mt-7 rounded-3xl border border-slate-200 bg-slate-50 p-5 sm:mt-8 sm:p-6">
                ...
                <p className="mt-5 text-sm leading-6 text-slate-500 sm:mt-6 sm:leading-7">
